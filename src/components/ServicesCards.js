  ...
  return (
    <Container className="service-cards-container container-margin ">
      ...
      <Row className="align-center margin-top">
        <Col md={4} className="service-card align-left d-flex flex-column  container-margin">
          <StaticImage
          ...
          <div className="d-grid gap-2 mt-auto ">
            <Button href="/services/commercial" variant="secondary">read more</Button>
          </div>
        </Col>
        <Col md={4} className="service-card align-left d-flex flex-column  container-margin">
          <StaticImage
          ...
          <div className="d-grid gap-2 mt-auto">
            <Button href="/services/janitorial" variant="secondary">read more</Button>
          </div>
        </Col>
        <Col md={4} className="service-card align-left d-flex flex-column  container-margin">
          <StaticImage
          ...
          <div className="d-grid gap-2 mt-auto ">
            <Button href="/services/construction-cleaning" variant="secondary">read more</Button>
          </div>
        </Col>
      </Row>
    </Container>
